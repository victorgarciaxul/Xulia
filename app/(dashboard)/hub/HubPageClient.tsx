...
export function HubPageClient({ firstName, userRole, conversations }: Props) {
    ...
    <div className="flex h-full bg-[#f4f4f6]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="bg-white border-b border-[#e5e5ea] px-5 py-2.5 flex items-center gap-3">
          <ModelSelector value={selectedModel} onChange={setSelectedModel} userRole={userRole} canUsePaidModels={false} />
        </div>
