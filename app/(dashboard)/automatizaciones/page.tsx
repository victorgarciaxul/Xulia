...
const TEMPLATES: Template[] = [
  {
    ...
    time: '2-3 horas',
    saves: '4h/semana',
    tools: ['Make', 'Google Analytics', 'Meta API', 'Gmail', 'XULIA AI'],
    steps: [
      { title: 'Trigger: cada lunes a las 8:00', description: 'Configura un trigger de tipo "Scheduled" en Make que se active todos los lunes a las 8:00.', tool: 'Make' },
  ...
  },
  {
    ...
    tools: ['Make', 'RSS / Webhook', 'XULIA AI', 'Buffer / Hootsuite'],
    steps: [
      { title: 'Trigger: nuevo artículo publicado', description: 'Configura un módulo RSS Watch en Make apuntando al feed de tu blog. O usa un webhook si tu CMS lo soporta (WordPress, Webflow, etc.).', tool: 'Make / RSS' },
      { title: 'Extraer título y contenido', description: 'Usa el módulo de texto de Make para extraer: título del artículo, URL, primer párrafo (extracto). Estos serán el input para la IA.', tool: 'Make' },
  ...
  },
  {
    ...
    time: '1 hora',
    saves: '2h/semana',
    tools: ['Make', 'Typeform / Gravity Forms', 'XULIA AI', 'Gmail', 'HubSpot / Notion'],
    steps: [
      { title: 'Trigger: nuevo envío de formulario', description: 'Conecta Typeform, Gravity Forms o tu formulario web mediante webhook a Make. Captura: nombre, email, empresa, mensaje.', tool: 'Typeform' },
  ...
  },
  {
    ...
    time: '2 horas',
    saves: '1h/día',
    tools: ['Make', 'Google Alerts / Mention', 'XULIA AI', 'Slack'],
    steps: [
      { title: 'Configurar fuentes de monitorización', description: 'Opción A (gratuita): configura Google Alerts para el nombre de la marca/cliente y recibe resultados por RSS.\nOpción B (de pago): usa Mention.com o Brand24 con integración directa en Make.', tool: 'Google Alerts' },
      { title: 'Trigger: nueva mención detectada', description: 'Conecta el feed RSS de alertas a Make con el módulo "RSS Watch". Se activa cada vez que aparece una nueva mención.', tool: 'Make' },
      ...
      { title: 'Filtrar por relevancia', description: 'Usa un router en Make para separar: menciones urgentes (sentiment negativo + urgencia >3) → canal de crisis. Menciones positivas → canal de oportunidades. Neutras → resumen diario.', tool: 'Make' },
  ...
  },
  {
    ...
    tools: ['Make', 'Whisper / Otter.ai', 'XULIA AI', 'Notion / Gmail'],
    steps: [
      ...
      { title: 'Trigger: nuevo archivo en la carpeta', description: 'Make detecta cuando se sube un nuevo archivo a la carpeta de Drive y lanza el flujo automáticamente.', tool: 'Make + Drive' },
      ...
      { title: 'Enviar resumen al equipo', description: 'Envía un email con el resumen a todos los asistentes (extrae los emails de la transcripción o tenlos guardados en el escenario de Make).', tool: 'Gmail' },
    ],
  ...
  },
  {
    ...
    time: '2 horas',
    saves: '4h por pliego',
    tools: ['Make', 'Google Drive', 'XULIA AI', 'Gmail / Notion'],
    steps: [
      ...
      { title: 'Trigger: nuevo PDF en la carpeta', description: 'Make detecta el nuevo archivo y lo descarga para procesarlo.', tool: 'Make' },
      { title: 'Extraer texto del PDF', description: 'Usa el módulo PDF de Make (o una API como PDF.co) para extraer el texto completo del pliego. Para pliegos muy largos (+100 páginas), divide en secciones.', tool: 'Make / PDF.co' },
  ...
  },
  {
    ...
    tools: ['Make', 'DocuSign / PandaDoc', 'Google Drive', 'XULIA AI', 'Asana / Notion', 'Gmail'],
    steps: [
      { title: 'Trigger: contrato firmado', description: 'Conecta DocuSign o PandaDoc a Make. El trigger se activa cuando un contrato cambia a estado "completed/signed". Extrae: nombre del cliente, servicio contratado, importe, responsable de cuenta.', tool: 'DocuSign' },
      { title: 'Crear estructura de carpetas en Drive', description: 'Usa la plantilla de carpetas de la agencia. Make crea automáticamente: /Clientes/[NOMBRE_CLIENTE]/{Briefings, Creatividades, Informes, Facturas, Contratos}.', tool: 'Google Drive' },
  ...
  },
  {
    ...
    time: '1 hora',
    saves: '1h/día',
    tools: ['Make', 'RSS / News API', 'XULIA AI', 'Email / Slack'],
    steps: [
      ...
      { title: 'Trigger: cada día a las 7:00', description: 'Make ejecuta el escenario a las 7:00 para recopilar noticias de las últimas 24 horas.', tool: 'Make' },
...
const TOOL_COLORS: Record<string, string> = {
  'Make': 'bg-purple-50 text-purple-700',
